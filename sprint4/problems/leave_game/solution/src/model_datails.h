...
namespace model_details {
	...
	const std::string key_lost_objects = "lostObjects"s;
	const std::string key_bag = "bag"s;
	const std::string key_score = "score"s;
	const std::string key_move = "move"s;
	const std::string key_time_delta = "timeDelta"s;
	const std::string key_dog_retirement_time = "dogRetirementTime"s;
}
