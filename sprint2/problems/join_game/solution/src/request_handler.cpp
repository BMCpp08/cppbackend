...
namespace http_handler {
	...
	json::array ApiHandler::LoadRoadsToJson(const model::Map* map) const {
		json::array roads;
	...
	json::array ApiHandler::LoadBuildingsToJson(const model::Map* map) const {
	...
	json::array ApiHandler::LoadOfficesToJson(const model::Map* map) const {
		json::array offices;
